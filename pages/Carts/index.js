                ...
                <div className="flex shadow-md my-10 border-4 rounded-lg">
                    <div className="w-3/4  px-10 py-10 ">
                        ...
                        {cartData.map((cartsdata) => {
                            return (
                                <div className="flex items-center -mx-8 px-6 py-5" key={cartsdata.name}>
                                    ...
                                    <div className="flex justify-center w-1/5">
                                        ...
                                        <input className="mx-2 text-black border text-center w-8" type="text" defaultValue={cartsdata.quantity} />
                                        <button>
                                            <svg className="fill-current text-gray-600 w-3" viewBox="0 0 448 512">

...
router.get("/create_payment_url", cors.cors, function (req, res, next) {
  res.render("order", { title: "Tạo mới đơn hàng", amount: 10000 });
});

router.get("/querydr", cors.cors, function (req, res, next) {
  let desc = "truy van ket qua thanh toan";
  res.render("querydr", { title: "Truy vấn kết quả thanh toán" });
});

router.get("/refund", cors.cors, function (req, res, next) {
...
router.post(
  ...
  async (req, res, next) => {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error saving order details", error });
    }
...
router.get("/vnpay_return", cors.cors, async (req, res, next) => {

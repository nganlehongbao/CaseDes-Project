            ...
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">
                        Girly Glam Rose Gold Glitter Holographic Iridescent Ombre Gradient
                    </h2>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img
                            src="https://cdn-image02.casetify.com/usr/3089/3453089/~v5182/7997298x2_iphone-15-pro-max__color_natural-titanium_16005972.png.1000x1000-w.m80.webp"
                    ...
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img
                                src="https://cdn-image02.casetify.com/usr/3089/3453089/~v5182/7997298x2_iphone-15-pro-max__color_blue-titanium_16005972.png.1000x1000-w.m80.webp"
                                alt="Wooden chair - preview 1"
                            />
                        </div>
                        <div className="bg-gray-100 flex justify-center items-center py-4">
                            <img
                                src="https://cdn-image02.casetify.com/usr/3089/3453089/~v5182/7997298x2_iphone-15-pro-max__color_white-titanium_16005972.png.1000x1000-w.m80.webp"
            ...
            <div className="flex  justify-center items-center w-full">
                <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
                    <div>
                        ...
                        ></img>
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">Ultra Bounce corners</p>
                    </div>
                    <div>
                        <img
                            className="h-25 w-20"
                        ...
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">32.8 ft. drop protection</p>
                    </div>
                    <div>
                        <img
                            className="h-25 w-20"
                        ...
                        ></img>
                        <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">10x MIL-STD-810G</p>
                    </div>
                    <div>
                        <img
                            className="h-25 w-20"

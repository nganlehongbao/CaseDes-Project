  ...
  const [cartData, setCartData] = useState([
    {
      ...
      type: "Apple",
      image:
        "https://cdn.tgdd.vn/Products/Images/60/85308/op-lung-iphone-6-6s-plus-nhua-hinh-thu-osmia-tho-t-org-2.jpg",
      quantity: 2,
      price: 400.0,
    },
    {
      ...
      type: "Xiaomi",
      image:
        "https://lzd-img-global.slatic.net/g/p/38e1fa7dccd67bb527e13d3dec47ea60.jpg_400x400q80.jpg_.webp",
      quantity: 1,
      price: 150.0,
    },
    {
      ...
      type: "Samsung",
      image:
        "https://cdn.tgdd.vn/Products/Images/60/235267/op-lung-galaxy-a12-nhua-deo-glue-case-meeker-20101--1-600x600.jpg",
      quantity: 1,
      price: 150.0,
    },
  ]);
            ...
            {cartData.map((cartsdata, index) => {
              return (
                ...
                >
                  ...
                  <span className="text-center w-1/5 font-semibold text-sm">
                    ${cartsdata.price * cartsdata.quantity}
                  </span>
                </div>
              );
            })}

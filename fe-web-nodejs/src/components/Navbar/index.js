            ...
            <div className="py-4">
                <div className="container flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center gap-4">
                        ...
                        <div className='flex'>
                            <div>
                            <Button primary to={'/login'} leftIcon={<FontAwesomeIcon icon={faRightToBracket} />}>
                                Login
                            </Button>
                        </div>
                        <div>
                            <Button outline to={"/register"} leftIcon={<FontAwesomeIcon icon={faRightToBracket} />}>
                                Regist
                            </Button>
                        </div>
                        </div>
                        ...
                        {username && (
                          <div className="navbar-nav font-weight-bold py-0 d-flex mr-2">
                              ...
                              <Button onClick={handleLogout} leftIcon={<FontAwesomeIcon icon={faRightToBracket} />}>
                              Logout
                            </Button>
                      </div>

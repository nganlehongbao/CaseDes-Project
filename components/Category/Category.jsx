...
import Image1 from '../../assets/casdes/3.png';
import Image2 from '../../assets/casdes/4.png';
import Image3 from '../../assets/casdes/5.png';
            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end">
                        ...
                        <img src={Image1} alt="" className="w-[320px]  absolute mr-4 bottom-0" />
                    </div>
                    {/* second col */}
                    ...
                    <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[320px] flex items-end">
                        ...
                        <img src={Image3} alt="" className="w-[450px] absolute top-1/2 -translate-y-1/2 -right-0" />
                    </div>
                </div>
            </div>
        </div>
